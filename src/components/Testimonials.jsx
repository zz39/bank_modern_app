...
const Testimonials = () => (
  ...
  ${styles.flexCenter} flex-col relative`}>
    ...
    sm:mb-16 mb-6 relative z-[1]">
      <h1 className={styles.heading2}>What people are <br className='
      sm:block hidden'></br> saying about us</h1>
    ...
    <div className="flex flew-wrap sm:justify-start justify-center w-full
